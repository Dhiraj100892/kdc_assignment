function [r, p, y] = active_set_algo( Target, LinkLength, MinRoll, MaxRoll, MinPitch, MaxPitch, MinYaw, MaxYaw, Obstacles )
...
%% optimization
%fig = figure()
options = optimset('MaxFunEvals',1000,'Algorithm','active-set');
